...
execute_process(COMMAND rclone copy ${archive} ${PACKAGE_REMOTE}:${upload_root})

# upload plots directory to avoid needing to extract on local computers
# that is for others to quickly preview plots
execute_process(COMMAND rclone copy ${out_dir}/plots ${PACKAGE_REMOTE}:${upload_root}/plots/${name})
