...
direcconfig='./'
direcgrid=[gemini_root,'/../simulations/input/GDI_periodic_Lamarche/inputs/']


%OUTPUT FILE LOCATION
outdir=[gemini_root,'/../simulations/input/GDI_periodic_Lamarche_fields/';]
mkdir(outdir);
...
for it=1:lt
  ...
  Eyit(:,:,it)=-43.8e-3*ones(llon,llat);
end
