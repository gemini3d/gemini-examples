...
def fac_SCW2(E: xarray.Dataset, gridflag: int, flagdip: bool) -> xarray.Dataset:
    """
    ...
    fac = fac_input(
        times, mlons, mlats, centerlon=centerlon, sigmat=5, width=width, scaling=5, duration=5
    )  # [A/m2]
