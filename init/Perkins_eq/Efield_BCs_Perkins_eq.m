...
direcconfig='./'
direcgrid= '~/simulations/raid/Perkins_eq/';


%OUTPUT FILE LOCATION
outdir= '~/simulations/raid/Perkins_eq/inputs/fields/'
mkdir(outdir);
...
for it=1:lt
  E.Exit(:,:,it)=7.07e-3*ones(llon,llat);   %V/m, in the x2 direction
  E.Eyit(:,:,it)=7.07e-3*ones(llon,llat);   %x3 direction
end
