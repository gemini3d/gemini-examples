...
function E = Jcurrent_target(E, Nt, dt)
...
velx=0;
vely=-0.0025;     %degrees mlat per second
for it=1:Nt
    time=it*dt;
    mlatctr=E.mlatmean+vely*time+displace*tanh((E.MLON-E.mlonmean)/(E.mlonsig));
    E.flagdirich(it)=0;
